...
use App\Http\Controllers\API\Onboarding\AdOptimizationFilterController;
...
Route::middleware(['auth.token'])->group(function () {
    ...
    Route::prefix('onboarding')->group(function () {
        ...
        Route::get('adoptimization/siteslist', [AdOptimizationFilterController::class, 'getSitesList']);
        Route::get('adoptimization/productlist', [AdOptimizationFilterController::class, 'getLiveProductList']);
        Route::get('adoptimization/publisherlist', [AdOptimizationFilterController::class, 'getPublisherList']);
        Route::get('adoptimization/prebidlist', [AdOptimizationFilterController::class, 'getPrebidVersionList']);
        Route::get('adoptimization/accountlist', [AdOptimizationFilterController::class, 'getAccountManagerList']);

        Route::post('adoptimization/allsites', [AdOptimizationOnboardingController::class, 'getAllSitesList']);
        Route::post('adoptimization/recent', [AdOptimizationOnboardingController::class, 'getRecentSitesList']);
        Route::post('adoptimization/favourites', [AdOptimizationOnboardingController::class, 'getFavouritesSitesList']);
        Route::post('adoptimization/archivesites', [AdOptimizationOnboardingController::class, 'getArchiveSitesList']);

        Route::get('adoptimization/site/{site_id}', [AdOptimizationOnboardingController::class, 'getSiteDetail']);
        Route::get('adoptimization/publisher/{id}', [AdOptimizationOnboardingController::class, 'getPublisherDetail']);
        Route::put('adoptimization/site/{site_id}', [AdOptimizationOnboardingController::class, 'editSiteDetail']);
        Route::put('adoptimization/publisher/{id}', [AdOptimizationOnboardingController::class, 'editPublisherDetail']);
        Route::put('adoptimization/update/status', [AdOptimizationOnboardingController::class, 'updateSiteStatus']);
        Route::post('adoptimization/site/create', [AdOptimizationOnboardingController::class, 'createSites']);
        Route::post('adoptimization/publisher/create', [AdOptimizationOnboardingController::class, 'createPublisher']);
    });
